(() => {
  // เริ่มเขียนโค้ด
  const key = "652d714f-0823-40a6-b467-d6146091763e";
  ...
  function setAirQualityColor(aqi){
    if (aqi <= 50){ document.documentElement.style.setProperty(
        '--current-aqi-color',
          'var(--good-aqi-color)'
      );
    } else if (aqi <= 100) { document.documentElement.style.setProperty(
      '--current-aqi-color',
